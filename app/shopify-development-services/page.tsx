...
export const metadata: Metadata = {
  ...
  description:
    "Custom Shopify development services for ecommerce businesses. We build fast, scalable, and SEO-friendly Shopify stores for global brands.",

  alternates: {
    canonical:
      "https://www.mvpinfotech.in/shopify-development-services",
  },
  ...
  openGraph: {
    ...
    description:
      "Professional Shopify development services including custom themes, store setup, migration, and ecommerce optimization.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Custom Shopify Development Services",
      },
    ],
  },
  ...
  twitter: {
    ...
    description:
      "Build modern ecommerce stores with expert Shopify developers.",
  ...
  return (
    <main>
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text:
                    "Shopify development includes designing, building, and optimizing ecommerce stores using the Shopify platform.",
                },
              },
              {
                "@type": "Question",
                name: "Do you provide Shopify migration services?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text:
                    "Yes, we migrate ecommerce websites from WooCommerce, Magento, and other platforms to Shopify.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text:
                    "Yes, we optimize Shopify ecommerce websites for better speed, SEO performance, and search visibility.",
                },
              },
            ],
          }),
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#95BF47] via-[#22c55e] to-[#1e3a8a]" />
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-white/80 text-lg">
              Build fast, modern, and conversion-focused ecommerce stores with custom Shopify development solutions tailored for growing businesses.
            </p>

            <p className="mt-4 text-white/70">
              We help brands improve user experience, store performance, SEO visibility, and online sales with scalable ecommerce development.
            </p>
          ...
          <div>
            <Image
              src="/shopify.png"
              alt="Custom Shopify ecommerce development"
              width={600}
              height={450}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <Image
              src="/dashboard.png"
              alt="Shopify ecommerce dashboard"
              width={600}
              height={400}
          ...
          <div>
            ...
            <h2 className="text-3xl font-semibold">
              Custom Shopify Development Solutions
            </h2>

            <p className="mt-6 text-gray-600">
              We build custom Shopify ecommerce stores designed for performance, usability, and long-term growth. Our development approach focuses on clean design, fast loading speed, mobile responsiveness, and SEO-friendly structure.
            </p>

            <p className="mt-4 text-gray-600">
              Whether you need a new Shopify website, theme customization, migration service, or ongoing support, our team delivers scalable ecommerce solutions tailored to your business requirements.
            </p>
            ...
            <ul className="mt-6 space-y-3 text-gray-600">
              <li>✔ Fast-loading ecommerce stores</li>
              <li>✔ Mobile responsive design</li>
              <li>✔ SEO-friendly development</li>
              <li>✔ Clean UI/UX structure</li>
              <li>✔ Ongoing support & maintenance</li>
              <li>✔ Scalable ecommerce solutions</li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            ...
            <Link
              ...
              className="p-6 rounded-2xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition"
            >
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mt-10 space-y-8">
            ...
            <div>
              <h3 className="text-xl font-semibold">
                Do you provide Shopify migration services?
              </h3>

              <p className="mt-2 text-gray-600">
                Yes, we migrate ecommerce websites from WooCommerce, Magento, and other ecommerce platforms to Shopify.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Yes, we optimize Shopify stores for search engines, performance, and better user experience.
              </p>
            </div>
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-center">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="mt-4 text-white/80">
            Build a scalable ecommerce website with custom Shopify development solutions.
          </p>
